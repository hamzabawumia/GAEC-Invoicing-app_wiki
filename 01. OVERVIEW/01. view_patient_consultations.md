# 📘 Use Case: View Patient Consultations

## 🎯 Goal

Allow staff to retrieve a patient’s consultation attendance records for a given date.
...
```
GET /invoicing_api/consultations/

/consultations/?patient_id=102&date=2025-04-03
...
2. User provides:
   ...
   - ## Note that patient_id is different from the Patient Card Number
